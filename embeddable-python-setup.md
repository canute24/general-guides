...
###### Source: [https://fpim.github.io/posts/setting-up-python-windows-embeddable-environment-properly/](https://fpim.github.io/posts/setting-up-python-windows-embeddable-environment-properly/)
...
should be treated as part of the application (â€œvendoringâ€) so that the developer can 
